/**
 * Created by jiangguisheng on 2018/6/23.
 */
...
//const REQUEST_URL = 'http://114.55.72.11:8088/espar_client/api/queryDiary.do?size=1&index=';
//let pageNo = 0;//当前第几页
...
export default class DaRenList extends Component {
	constructor(props) {
		super(props);
		this.state = {
			isLoading: true,
	...
	//			<Text style={styles.title}>name: {item.value.Title}</Text>
	//			<Text style={styles.content}>stars: {item.value.Title}</Text>
	//			<Text style={styles.content}>description: {item.value.Title}</Text>
	//		</View>
	//	);
	//}
	_renderItemView({item}) {
